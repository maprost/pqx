...
func ContainsEntityById(tx Transaction, entity interface{}, id int64) (bool, error) {
...
func ContainsEntityByKeyValue(tx Transaction, entity interface{}, key string, value interface{}) (bool, error) {
	structInfo := pqreflect.NewStructInfo(entity)
